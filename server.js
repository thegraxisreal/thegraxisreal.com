...
app.post('/api/chat', async (req, res) => {
  ...
  if (model === 'gpt-4.1-nano') {
    systemPrompt = "You are Klani. You are based off GPT-4.1 Nano by graxAI. Answer all questions accordingly. Try to keep responses very short and simple unless they need more detail, like for code.";
  } else {
    systemPrompt = "You are Klani.";
  }
